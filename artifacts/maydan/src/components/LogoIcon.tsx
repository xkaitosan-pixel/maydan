...
const LogoIcon = ({ size = 80 }: LogoIconProps) => (
  ...
  >
    ...
    {/* Left sword (top-left → bottom-right) */}
    <g filter="url(#mdSwordGlow)">
      <polygon
        points="26,20 32,20 92,84 86,90"
        fill="url(#mdBladeL)"
        stroke="#8a6d0f"
        strokeWidth="0.5"
      />
    ...
    <g filter="url(#mdGemGlow)">
      ...
      <polygon
        points="60,47 67,55 60,63 53,55"
        fill="#c084fc"
        opacity="0.55"
      />
