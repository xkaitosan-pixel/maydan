...
export const questions: Question[] = [
  ...
  { id: 39, question: "كم عدد أوجه الزهرة السداسية؟", options: ["5", "6", "7", "8"], correct: 1, category: "general", difficulty: "easy" },
  ...
  { id: 51, question: "في أي رياضة يُستخدم مضرب البادل؟", options: ["تنس الطاولة", "تنس الأرض", "سكواش", "بادمنتون"], correct: 3, category: "sports", difficulty: "medium" },
  ...
  { id: 56, question: "ما هو أعلى هدف في تاريخ كأس العالم لكرة القدم يسجله لاعب واحد في مباراة واحدة؟", options: ["3", "4", "5", "6"], correct: 1, category: "sports", difficulty: "hard" },
  ...
  { id: 64, question: "ما هي المسلسلة العربية الأكثر شهرة في رمضان عام 2023؟", options: ["نسل الأغراب", "الاختيار", "المداح", "أوراق الشجر"], correct: 0, category: "movies", difficulty: "hard" },
  ...
  { id: 80, question: "ما هي لعبة بطولة الرياض الإلكترونية الأشهر؟", options: ["فيفا", "فورتنايت", "PUBG", "ليغ أوف ليجندز"], correct: 3, category: "gaming", difficulty: "hard" },
  ...
  { id: 90, question: "ما هي لعبة مجنونة أربعة في موبايل؟", options: ["ببجي موبايل", "فري فاير", "كلاش أوف كلانز", "كانديكراش"], correct: 0, category: "gaming", difficulty: "hard" },

  // ==================== ANIME (91-105) ====================
  { id: 91, question: "ما هو اسم أب ناروتو؟", options: ["جيرايا", "مينانو", "مينانو ناميكازي", "هيروكي"], correct: 2, category: "anime", difficulty: "medium" },
  ...
  { id: 94, question: "ما هو اسم التنين الذي يمتطيه داهنيريس في 'Game of Thrones'؟", options: ["سيرسي", "درياغون", "دروغون", "رايغال"], correct: 2, category: "anime", difficulty: "medium" },
  ...
  { id: 104, question: "في 'ون بيس'، ما اسم ناقلة الأخطبوط الضخمة؟", options: ["ثاوزند صني", "غوينج ميري", "ريد فورس", "ماريجوا"], correct: 0, category: "anime", difficulty: "easy" },
  ...
  { id: 110, question: "ما هو اسم أول سيارة صنعها هنري فورد؟", options: ["فورد T", "فورد A", "فورد موستانغ", "فورد صني"], correct: 0, category: "cars", difficulty: "medium" },
  ...
  { id: 115, question: "ما عمر شركة 'لمبرغيني'؟", options: ["منذ 1940", "منذ 1963", "منذ 1975", "منذ 1955"], correct: 1, category: "cars", difficulty: "hard" },
  ...
  { id: 175, question: "من هو الفيلسوف العربي الذي قال 'أنا أفكر إذن أنا موجود'؟", options: ["ابن سينا", "ديكارت", "الفارابي", "ابن رشد"], correct: 1, category: "arabhistory", difficulty: "hard" },
  ...
  { id: 188, question: "كم عدد ألوان قوس قزح؟", options: ["5", "6", "7", "8"], correct: 2, category: "animals", difficulty: "easy" },
